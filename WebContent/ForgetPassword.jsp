...
<div class="container">
       <br/>  ${msg} 
		...
		<div class="login">
			...
			<form action="ForgetPasswordServelt.java" method="post">
			<div class="col-md-6 login-do">
				<div class="login-mail">
				newPassword <input type="password" placeholder="newPassword" required="">
					<i class="glyphicon glyphicon-lock"></i>
				</div>
				<div class="login-mail">
				reenterPassword <input type="password" placeholder="reenterPassword" required="">
					<i class="glyphicon glyphicon-lock"></i>
				</div>
