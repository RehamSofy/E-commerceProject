...
<%
   Person person=(Person)request.getSession().getAttribute("list");
%>
<div class="header">
<div class="container">
		<div class="head">
...
<div class="container">
		<div class="login">
			...
			<div class="login-mail">
					<input type="text" placeholder="First Name" required="" value="<%=person.getFirstName()%>" name="fname">
					<i class="glyphicon glyphicon-user"></i>
			</div>
			<div class="login-mail">
					<input type="text" placeholder="Last Name" required="" name="lname" value="<%=person.getLastName()%>">
					<i  class="glyphicon glyphicon-user"></i>
			</div>
			<div class="login-mail">
					<input type="tel" placeholder="Phone Number" required="" value="<%=person.getPhoneNumber()%>" name="phone">
					<i  class="glyphicon glyphicon-phone"></i>
			</div>
				<div class="login-mail">
					<input type="email" placeholder="Email" required="" value="<%=person.getEmail()%>" name="email">
					<i  class="glyphicon glyphicon-envelope"></i>
				</div>
				<div class="login-mail">
					<input type="password" placeholder="Password" required="" value="<%=person.getPassword()%>" name="password">
					<i class="glyphicon glyphicon-lock"></i>
				</div>
				  
			    <div class="login-mail">
					<input type="text" placeholder="Job" required="" value="<%=person.getJob()%>" name="job">
					<i  class="glyphicon glyphicon-briefcase"></i>
				</div>
				<div class="login-mail">
					<input type="date" placeholder="Birthday" required="" value="<%=person.getBirthday()%>" name="birthday">
					<i  class="glyphicon glyphicon-calendar"></i>
				</div>
				<div class="login-mail">
					<input type="text" placeholder="address" value="<%=person.getAddress()%>" required="" name="add">
					<i  class="glyphicon glyphicon-globe"></i>
				</div>
				
				<div class="login-mail">
					<input type="text" placeholder="credit Number" value="<%=person.getCreditNumber()%>" required="" name="cn">
					<i  class="glyphicon glyphicon-shopping-cart"></i>
				</div>
				<div class="login-mail">
					<input type="text" placeholder="credit limit" value="<%=person.getCreditLimit()%>" required="" name="cl">
					<i  class="glyphicon glyphicon-shopping-cart"></i>
				</div>
