...
-->
<%@page import="com.model.OrderHistory"%>
...
<div class="banner-top">
	<div class="container">
		<h1>Order History</h1>
		<em></em>
		<h2><a href="index.html">Home</a><label>/</label>Order History</h2>
	</div>
</div>
<!--login-->
...
<div class="container">
    ...
    <div class="table-responsive">
		  ...
		  <%
     ArrayList<OrderHistory> orders=(ArrayList<OrderHistory>) request.getAttribute("orderList");

     for(int i=0;i<orders.size();++i){	 	
      String path="images/"+orders.get(i).getIdProductOrder()+".jpg";
%>
		  <tr class="cart-header">

			<td class="ring-in"><a href="single.html" class="at-in"><img src=path class="img-responsive" alt=""></a>
			
			<div class="clearfix"> </div>
			<div class="close1"> </div></td>
			<td><%=orders.get(i).getPrice() %></td>
			<td><%= orders.get(i).getIdOrderHistory() %></td>
